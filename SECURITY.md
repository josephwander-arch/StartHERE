...
If you discover a security vulnerability in StartHERE, please report it privately
via GitHub's Private Vulnerability Reporting:

1. Go to https://github.com/AIWander/StartHERE/security
...
StartHERE is under active development. Only the latest release receives security
fixes. Older releases are not supported.

## Scope

In scope:
- The StartHERE binary/library and any bundled assets
